...
const Layout = ({ children }: LayoutProps) => {
  ...
  const userMenuItems = [
    ...
    { to: '/annual-missions', icon: Trophy, label: 'Missões Anuais' },
    { to: '/tasks', icon: Target, label: 'Tarefas' },
    { to: '/races', icon: Route, label: 'Corridas' },
    ...
    { to: '/social', icon: MessageSquare, label: 'Rede Social' },
  ...
  const adminMenuItems = [
    ...
    { to: '/admin/annual-missions', icon: Trophy, label: 'Missões Anuais' },
    { to: '/admin/tasks', icon: ClipboardList, label: 'Tarefas' },
    { to: '/admin/races', icon: Route, label: 'Gerenciar Corridas' },
    { to: '/admin/learn', icon: School, label: 'Conteúdo' },
    { to: '/admin/learning-path', icon: Map, label: 'Trilhas' },
